import { BadRequestException, Body, Controller, Get, GoneException, Headers, Param, Post, UseGuards } from "@nestjs/common";
import { marketplaceAgreementDecisionSchema, signMarketplaceAgreementSchema } from "@marketplace/schemas";
...
export class MarketplaceAgreementsController {
  ...
  @Post() @RequirePermissions("document.manage") initiate() { throw new GoneException("Новые поставщики принимают общие условия в кабинете: /supplier-terms/current"); }
