...
const defaults = [
  {
    ...
    evidence: ["Ручные офферы, остатки и подтверждение заказа реализованы"], runbookPath: "actual_docs/integrations/runbooks/manual-supplier.md", owner: "Supplier Operations",
  },
  {
    ...
    evidence: ["Импорт, preview и pipeline заданий реализованы"], runbookPath: "actual_docs/integrations/runbooks/file-import.md", owner: "Catalog Operations",
  },
  {
    ...
    evidence: ["Адаптер, signed webhook, jobs, retry и reconciliation реализованы"], runbookPath: "actual_docs/integrations/runbooks/moysklad.md", owner: "Integration Operations",
  },
  {
    ...
    evidence: ["Enrollment, heartbeat, job lease, retry и offline state реализованы на сервере"], runbookPath: "actual_docs/integrations/runbooks/one-c-agent.md", owner: "Integration Operations",
  },
  {
    ...
    evidence: ["Generic HTTPS adapter, normalization, retries, idempotency and connection registry реализованы"], runbookPath: "actual_docs/integrations/runbooks/external-adapters.md", owner: "Integration Operations",
  },
] as const;
