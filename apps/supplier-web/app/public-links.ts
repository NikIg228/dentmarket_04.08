...
const buyerUrl = process.env.NEXT_PUBLIC_BUYER_APP_URL ??
  (process.env.NODE_ENV === "development" ? "http://127.0.0.1:3001" : "https://dentmarket-store.vercel.app");
export const publicCatalogUrl = `${buyerUrl.replace(/\/$/, "")}/catalog`;
