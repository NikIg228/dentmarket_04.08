...
> Исходный файл: `actual_docs/governance/PROJECT_STATE_SNAPSHOT_2026-09-08.md`.
...
| Production go-live | NO-GO | CWE-319 и локальный readiness contract закрыты; production B4.6, live PSP/EDS/connectors/notifications и provider-managed infrastructure ожидают реальные credentials и receipts |
