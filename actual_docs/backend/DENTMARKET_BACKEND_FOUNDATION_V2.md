...
| Обычная акция, включая «3 + 1» | CORE-03/04, B5 | Сначала контракт условий, подарочных строк, отмен/частичного исполнения; точные суммы, резерв подарка, revalidation, idempotency, tenant; PostgreSQL и affected UI flow |
