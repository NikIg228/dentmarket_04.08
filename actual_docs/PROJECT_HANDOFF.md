...
Последнее решение владельца 21.09: **редизайн нужен максимально близко к прежним
...
классифицировать прежние референсы, минимально обновить UI standards/handoff/
PRIMARY-SESSION и предъявить набор владельцу. Продуктовая реализация пока не
назначена. Ждать подтверждения набора; известный CI-blocker не исправлять.
