...
const buildDirectory = resolve(repositoryRoot, "apps/supplier-web/.next");
...
const MAX_INITIAL_JS_RAW_BYTES = 1_250_000;
const MAX_INITIAL_JS_GZIP_BYTES = 380_000;
...
if (!routeManifest) {
  throw new Error("Supplier /page client reference manifest was not found");
}
...
if (violations.length) {
  throw new Error(`Supplier bundle budget failed: ${violations.join("; ")}`);
}
